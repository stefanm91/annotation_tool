...
class SampleApp(tk.Tk):
	...
	self.title("Data annotation")
        ...
        self.polygon_id = 0
        #self.rectangle_size = [100,100
        self._create_token((100, 100), "red")
        #self._create_token((200, 100), "black")
               
        # 
        self.video_folder = os.path.abspath("/home/stefan/Documents/plexondata/2015_12_02_rat10/output/0/0/")
	...
	self.img_num = 0
	self.img = ImageTk.PhotoImage(Image.open(os.path.join(self.video_folder, "{0}.jpg".format(self.img_num))))
        self.img_id = self.canvas.create_image(140, 140, image = self.img, anchor="nw") #, anchor = NW
        # put image in label
	...
	self.polygon_id = self.canvas.create_polygon(x-0,y-0,x+100,y-0,x+100,y+40,x-0,y+40, outline='red', fill='', tags="token")
